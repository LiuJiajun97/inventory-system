...
const PurchaseRequisitionListPage = withSuspense(() =>
  import("./pages/purchase/PurchaseRequisitionListPage").then((m) => ({
    default: m.PurchaseRequisitionListPage,
  })),
);
const PurchaseRequisitionNewPage = withSuspense(() =>
  import("./pages/purchase/PurchaseRequisitionNewPage").then((m) => ({
    default: m.PurchaseRequisitionNewPage,
  })),
);
...
const SalesQuotationListPage = withSuspense(() =>
  import("./pages/sales/SalesQuotationListPage").then((m) => ({
    default: m.SalesQuotationListPage,
  })),
);
const SalesQuotationNewPage = withSuspense(() =>
  import("./pages/sales/SalesQuotationNewPage").then((m) => ({
    default: m.SalesQuotationNewPage,
  })),
);
...
// V26 价目表
const PriceListPage = withSuspense(() =>
  import("./pages/price/PriceListPage").then((m) => ({
    default: m.PriceListPage,
  })),
);
          ...
          <Routes>
            ...
            >
              ...
              <Route index element={<Navigate to="/dashboard" replace />} />
                ...
                <Route
                  path="purchase-requisitions/new/:id?"
                  element={
                    <RequireAuth>
                ...
                <Route
                  path="sales-quotations/new/:id?"
                  element={
                    <RequireAuth>
                      <SalesQuotationNewPage />
                    </RequireAuth>
                  }
                />
