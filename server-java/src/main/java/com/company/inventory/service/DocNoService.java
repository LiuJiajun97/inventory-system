...
public class DocNoService {
    ...
    /** 销售报价单号前缀。 */
    private static final String PREFIX_QUOTATION = "BJ";

    /** 请购单号前缀。 */
    private static final String PREFIX_REQUISITION = "QG";
     ...
     * @param salesQuotationMapper 销售报价单 Mapper
     * @param purchaseRequisitionMapper 请购单 Mapper
     */
    ...
    /**
     * 生成销售报价单号(BJ-YYYYMMDD-NNNN)。
     *
     * @return 单号
     */
    public String generateSalesQuotationNo() {
        return buildNo(PREFIX_QUOTATION, salesQuotationMapper, SalesQuotationDO::getDocNo);
    }

    /**
     * 生成请购单号(QG-YYYYMMDD-NNNN)。
     *
     * @return 单号
     */
    public String generatePurchaseRequisitionNo() {
        return buildNo(PREFIX_REQUISITION, purchaseRequisitionMapper, PurchaseRequisitionDO::getDocNo);
    }
